...
import pickle
class Prediction:
    def predict_journey_time(self, lineId, segments, departure_unix):
        
        # get route model
        model = self.get_route_model(lineId)
        ...
        isPeak = int(self.isPeaktime(departure_dt) == True)
        ...
        journeyTime = self.predict_journey_time_by_df(segments_df, lineId)
    ...
    def predict_journey_time_by_df(self, test_dataframe, lineId):
    ...
    def get_route_model(self, lineId):
        # path for model pickle
        modelFile = f'//Users/wenghsin-ping/Desktop/dublin-bus-app/WebApp/pickles/route_{lineId}.pkl'
