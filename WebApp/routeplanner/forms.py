...
class leapCardForm(forms.Form):
    ...
    username = forms.CharField(widget=forms.TextInput(attrs={'id': 'un', 'class':'form-input'}))
    password = forms.CharField(widget=widgets.PasswordInput(attrs={'id': 'pw', 'class':'form-input'}))
